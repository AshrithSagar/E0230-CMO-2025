...
\begin{enumerate}[label= (\alph*)]
    ...
    \item Let \( \func{f}{\x} = \a^\top \x \).
        ...
        \begin{solutionbox}
            ...
            \begin{align*}
                ...
                \; \a = {\left[a_{1}, a_{2}, \ldots, a_{d}\right]}^\top
                \\
                \implies
                \grad{f}{\x}
                & =
                {\left[\frac{\partial f}{\partial x_{1}}, \frac{\partial f}{\partial x_{2}}, \ldots, \frac{\partial f}{\partial x_{d}}\right]}^\top = {\left[a_{1}, a_{2}, \ldots, a_{d}\right]}^\top = \a
            \end{align*}
        \end{solutionbox}

        \newpage
    \item The hessian of \( \func{f}{\x} = \half \qf{\x}{A}, A = \outp{\u}{\v}, \u \neq \v \), is given by \( H = A \).
        ...
        \begin{solutionbox}
            ...
            \begin{align*}
                ...
                H \neq A
            \end{align*}
            Should have been given \( \u \neq \lambda \v \) instead of \( \u \neq \v \).
        \end{solutionbox}

    \item For \( f \), a \( \classC^2 \) function, consider a point \( \xhat \) such that \( \grad{f}{\xhat} = 0 \) and the Hessian is positive definite, \( \hess{f}{\xhat} \succ 0 \).
        Then \( \xhat \) is global minimum of \( f \).

        \begin{solutionbox}
            False.

            From the given conditions, \( f \in \classC^2, \grad{f}{\xhat} = 0, \hess{f}{\xhat} \succ 0 \), we can say that \( \xhat \) is a strict local minimum of \( f \) by the second order necessary condition for optimalilty.
    ...
    \item Suppose global minimum, \( \xhat \), exists for a function \( f \in \classC^1 \).
