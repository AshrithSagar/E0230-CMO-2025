...
The identity matrix \( \mathbf{I} \in \mathbb{R}^{d \times d} \) has eigenvalues \( \lambda_i = 1, \ \forall i \) and eigenvectors as the standard basis vectors \( \mathbf{e}_i \in \mathbb{R}^d \).

\subsection{Condition number}

The \textbf{condition number} of a matrix \( \mathbf{A} \in \mathbf{S}_{d} \) is defined as
\begin{equation*}
