...
\end{align*}
Now, by the characterisation of projection onto convex sets, i.e.,
\begin{equation*}
    \dotp
    ...
    \; \forall \z \in \R^d
\end{equation*}
Setting \( \z = \x^k - \alpha \, \grad{f}{\x^k} \) in the above, we have \( \func{P_{\calC}}{\z} = \x^{k+1} \), and thus
\begin{equation*}
    \therefore
    \dotp
...
\(
    ...
    \frac{1}{T}
    \sum_{k = 0}^{T - 1} \x^{k+1}
\), we have, from the convexity of \( g \), that
\begin{align*}
    \func{g}{\xbar}
    \leq
    \frac{1}{T}
    ...
    \norm{\x^0 - \xstar}_2^2
\end{align*}
Therefore, the rate of convergence is \( \bigoh{\frac{1}{T}} \), for convex functions.
