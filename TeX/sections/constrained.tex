...
A ""basic feasible solution"" (BFS) is a feasible solution \( \xhat \) of the "LP" problem where at most \( m \) components of \( \xhat \) are non-zero, and the corresponding columns of \( \A \) are linearly independent.
