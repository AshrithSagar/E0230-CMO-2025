...
Note that, for the strongly convex quadratic function~\psecref{sec:strongly-convex-quadratic-minimisation-problem}, from Taylor's theorem~\psecref{sec:multivariate-taylor-theorem}, we have
\begin{align*}
    \because
    \grad{f}{\y}
    & =
...
\begin{theorem}{}{}
    For the strongly convex quadratic function~\psecref{sec:strongly-convex-quadratic-minimisation-problem},
    ...
    \begin{equation*}
        ...
        \quad \forall i \in \set{0, 1, \ldots, k - 1}
    \end{equation*}
    and the iterates \( \set{\x^i}_{i = 0}^k \) satisfy
    \vspace{-0.5em}
    \begin{equation*}
