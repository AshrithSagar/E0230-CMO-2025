...
\paragraph{Condition for sufficient decrease (Armijo rule):}
\begin{equation*}
...
\paragraph{Condition for curvature (Wolfe condition):}
\begin{equation*}
...
\paragraph{Condition for strong curvature (strong Wolfe condition):}
\begin{equation*}
