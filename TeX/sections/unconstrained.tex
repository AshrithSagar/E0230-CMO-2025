...
Choose the step length \( \alpha_k \) by solving the one-dimensional optimisation problem
\begin{equation*}
...
\subsection{Convex quadratic minimisation problem}
...
\subsection{Sufficient decrease condition (Armijo condition)}
...
\subsection{Goldstein conditions / Armijo-Goldstein conditions}
...
\subsection{Sufficient decrease lemma}
...
\subsection{Global convergence criterion}
