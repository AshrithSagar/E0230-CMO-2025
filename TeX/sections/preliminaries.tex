...
\begin{itemize}
    ...
    \item \( \func{f}{\x} = \half \qf{\x}{\mathbf{A}}, \; \mathbf{A} = \mathbf{u} \mathbf{v}^\top, \; \mathbf{u}, \mathbf{v} \in \R^d, \; \mathbf{u} \neq \mathbf{v} \implies \hess{f}{\x} = \half (\mathbf{A} + \mathbf{A}^\top) = \half (\mathbf{u} \mathbf{v}^\top + \mathbf{v} \mathbf{u}^\top) \).
\end{itemize}
