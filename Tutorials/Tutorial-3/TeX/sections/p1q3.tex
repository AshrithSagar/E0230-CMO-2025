...
The error is always orthogonal to the subspace of the gradients computed so far.
This is because the CG method minimizes the error in the \( A \)--norm at every step, and hence the error must be orthogonal to the direction in which we are minimising.
