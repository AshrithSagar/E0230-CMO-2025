...
At \( k = d \), since \( \spanset{\p_i}_{i = 0}^{k - 1} \) are linearly independent, we get that the Krylov subspace becomes \( \R^d \) for any \( r_0 \), thereby, the final iterate \( \x^d \) is \underline{independent of the initial residual \( \r_0 \)}, but the intermediate search directions and iterates depend on \( \r_0 \).
