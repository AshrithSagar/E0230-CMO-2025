...
\newpage
The algorithm for \texttt{NEWTON\_SOLVE} is given below for reference.
...
This satisfies the condition for descent direction, provided that the Hessian is positive definite, since
\begin{align*}
    \hess{f}{\x^k}
    &
    \succ \zero
